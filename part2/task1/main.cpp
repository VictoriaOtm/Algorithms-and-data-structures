...
В первой строке записано единственное число — число точек N. N ≤ 10000. В последующих N строках записаны координаты точек xi, yi. Все координаты целочисленные xi, yi ≤ 100000.
Формат вывода
